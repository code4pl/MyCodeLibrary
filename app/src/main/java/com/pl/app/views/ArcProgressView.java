...
/**
 * Created by Alex Pang on 2016/9/2.
 * Custom progress view in arc-shape style
 */
public class ArcProgressView extends View {
	...
	private final int default_unfinished_color = 0x66ffffff;
	...
	public ArcProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		default_text_size = CommonUtil.sp2px(getResources(), 18);
		min_size = CommonUtil.dip2px(context, 100);
		default_text_size = CommonUtil.sp2px(getResources(), 40);
		default_suffix_text_size = CommonUtil.sp2px(getResources(), 15);
		default_suffix_padding = CommonUtil.dip2px(context, 1);
		default_suffix_text = "%";
		default_bottom_text_size = CommonUtil.sp2px(getResources(), 10);
		default_stroke_width = CommonUtil.dip2px(context, 4);
	...
	protected void onDraw(Canvas canvas) {
		...
		String text = getProgressStr();//String.valueOf(getProgress());
